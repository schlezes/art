...
var art = {
    ...
    "d6": [
        ...
        "<figure><img id=d72 class=radius src=img/fish.png height=100px width=200px title='Simple and original artwork. In this case a visual for a fish, like in fishing for customers.'><figure><figcaption>Artwork for slide set</figcaption><figcaption>Fish, as in fishing</figcaption></figure>",
        "<figure><img id=d73 class=radius src=img/digestion.png height=100px width=200px title='Simple and original artwork. In this case a visual for digestion, Fermentation from mixing water and hamburger.'><figure><figcaption>Artwork for slide set</figcaption><figcaption>Water and hamburger</figcaption></figure>",
        "<figure><img id=d74 class=radius src=img/cake.png height=100px width=200px title='Simple and original artwork. In this case a visual for a kind of food, creamy-chocolate cake'><figure><figcaption>Artwork for slide set</figcaption><figcaption>Creamy chocolate cake</figcaption></figure>",
        "<figure><img id=d75 class=radius src=img/msg.png height=100px width=200px title='Simple and original artwork. In this case a visual for a headache from msg additive to food'><figure><figcaption>Artwork for slide set</figcaption><figcaption>Headache from msg</figcaption></figure>",
        "<figure><img id=d76 class=radius src=img/nose.png height=100px width=200px title='Simple and original artwork. In this case a visual for a runny nose due to allergy'><figure><figcaption>Artwork for slide set</figcaption><figcaption>Miserable-runny nose</figcaption></figure>",
        "<figure><img id=d77 class=radius src=img/pet.png height=100px width=200px title='Simple and original artwork. In this case a visual for an allergy caused by a pet'><figure><figcaption>Artwork for slide set</figcaption><figcaption>pet allergy</figcaption></figure>",
        "<figure><img id=d78 class=radius src=img/pizza.png height=100px width=200px title='Simple and original artwork. In this case a visual for seasoning in a pizza'><figure><figcaption>Artwork for slide set</figcaption><figcaption>msg seasoning in pizza</figcaption></figure>",
        "<figure><img id=d79 class=radius src=img/eyes.png height=100px width=200px title='Simple and original artwork. In this case a visual for red and runny eyes due to allergy'><figure><figcaption>Artwork for slide set</figcaption><figcaption>Red and runny eyes</figcaption></figure>",
        "<figure><img id=d80 class=radius src=img/sneeze.png height=100px width=200px title='Simple and original artwork. In this case a visual of person sneezing, sideview with no hanky'><figure><figcaption>Artwork for slide set</figcaption><figcaption>Person sneezing-allergy</figcaption></figure>",
        "<figure><img id=d80 class=radius src=img/something.png height=100px width=200px title='Simple and original artwork. In this case a visual of person with headache because of something; however, no answer'><figure><figcaption>Artwork for slide set</figcaption><figcaption>Person with headache</figcaption></figure>",
